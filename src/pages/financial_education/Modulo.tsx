			...
			<div className="max-w-[1180px] p-5 flex flex-col w-full m-auto items-start justify-between">
				...
				<div className="flex mt-4 flex-col gap-4">
					<p className="leading-6 text-justify">
						Sua renda é o dinheiro que você ganha regularmente. Isso pode
						incluir salário, renda de aluguel, juros de investimentos e outros.
						É importante entender que a renda é a base de todas as suas
						finanças.
					</p>
					<p className="leading-6 text-justify">
					...
					<div>
						...
						<p className="leading-6 text-justify">
							...
							honorários, alugueis, juros ou lucros, antes do pagamento do
							imposto de renda e demais tributos pessoais
						</p>
					</div>
					<div>
						<h3 className="font-bold text-xl text-gray-500">
