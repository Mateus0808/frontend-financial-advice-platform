	...
	return (
		<>
			...
			<div className="max-w-[1180px] w-full m-auto flex flex-col gap-4 px-8 py-8">
				<div>
					<Span>
						Bem-Vindo à nossa Plataforma de Aconselhamento Financeiro para
						Jovens
					</Span>
					<Paragraph>
						Na Plataforma de Aconselhamento Financeiro para Jovens, nossa missão
						é capacitar indivíduos a tomar decisões financeiras informadas,
				...
				<div>
					...
					<Paragraph>
						...
						financeira próspera. Nossa plataforma foi projetada para ser um
						espaço acolhedor e informativo, independentemente do seu nível de
				...
				<div>
					...
					<Paragraph>
						...
						você faz parte de uma comunidade que valoriza o aprendizado contínuo
						e a prosperidade financeira. Estamos aqui para apoiá-lo em cada
						etapa de sua jornada financeira.
					</Paragraph>
				</div>
				<div>
